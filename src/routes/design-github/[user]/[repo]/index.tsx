	...
	return (
		<div>
			<div class='flex flex-col justify-center text-center'>
				<h1 class='text-slate-600 text-3xl mt-6 mb-4'>
					<a class="underline" href={'/design-github/' + location.params.user}>
			...
			<Repo repo={repository.value}>
				<div q:slot='title'>
					{location.params.user}/{location.params.repo}
				</div>
				<Form action={setFavoriteAction}>
					...
					/>
					<button>{isFavorite.value ? <FavoriteIcon /> : <HeartIcon />}</button>
				</Form>
			</Repo>
		</div>
	);
